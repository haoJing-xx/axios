...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mint_ui__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_mint_ui___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_mint_ui__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_mint_ui_lib_style_css__ = __webpack_require__(18);
...
__WEBPACK_IMPORTED_MODULE_4_axios___default.a.interceptors.response.use(function (config) {
  MintUi.Indicator.close();
  return config;
});

// baseUrl
__WEBPACK_IMPORTED_MODULE_4_axios___default.a.defaults.baseURL = "http://localhost:3000/";
...
router.beforeEach((to, from, next) => {
  ...
  // 发请求
  if (checkLogin) {
    __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get("users/god").then(res => {
      if (res.data.isLogin) {
        return next();
      }
